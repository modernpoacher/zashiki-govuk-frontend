...
import transform, {
  ...
  getErrorHref,
  transformError
} from 'zashiki-govuk-frontend/src/transformer/to-error-summary'
...
describe('zashiki-govuk-frontend/src/transformer/to-error-summary', () => {
  ...
  describe('`getErrorHref()`', () => {
    describe('With params', () => {
      it('returns a string', () => {
        return expect(getErrorHref({ uri: 'mock-uri' }))
          .to.equal('#mock-uri')
      })
    })
